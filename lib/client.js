      ...
      return react.createElement("ul", { className: styles.sessionList },
        sorted.map((session) => {
          ...
          return react.createElement("li", { className: styles.sessionRow, key: session.id },
            ...
            react.createElement("div", { className: styles.sessionBar, title: t("local.sessionBarHint", { tokens: fmtInt(tokens), pct }) },
...
/** Skeleton screen: shimmer placeholders matching the final card layout. */
    ...
    const zh = {
      ...
      "local.sessionBarHint": "{tokens} tokens · 占本工作区会话最大值 {pct}%",
    ...
    const en = {
      ...
      "local.sessionBarHint": "{tokens} tokens · {pct}% of workspace max",
