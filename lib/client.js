...
`;
     ...
     * mirroring the per-model list exactly: cost-scaled bar, hover tooltip
     * with the full token/cost breakdown (heading = the full path). Each
     * workspace expands its own session records through the same collapsible
     * pattern as the global session list.
     */
      ...
      return react.createElement("div", { className: styles.card },
        ...
        workspaces.map((w) => {
          ...
          return react.createElement("div", { className: styles.modelRow, key: w.path ?? "", onMouseEnter: (e) => show(e, content), onMouseLeave: hide },
            react.createElement("div", { className: styles.modelHead },
              react.createElement("span", { className: styles.modelName, title: w.path ?? undefined }, name),
            ...
            }, open ? t("local.sessionHide") : t("local.sessionToggle", { count: w.sessionCount })),
