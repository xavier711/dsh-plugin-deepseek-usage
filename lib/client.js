...
.du-activityGrid:not([data-view="daily"]) .du-activityWeek:hover .du-activityCell{opacity:1;box-shadow:0 1px 2px rgba(0,0,0,.18),0 0 5px rgba(34,197,94,.45)}
body[data-ds-dark-theme] .du-activityGrid:not([data-view="daily"]) .du-activityWeek:hover .du-activityCell{box-shadow:0 1px 3px rgba(0,0,0,.5),0 0 7px rgba(34,197,94,.55)}
