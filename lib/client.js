...
/* 有量的格子：投影 + 同色柔光，看起来像浮起来的一颗（参考 Codex 列视图的观感）。
   注意两条红线：**不要给列加底色**、**不要把列内间距压掉合并成一列** —— 用户都明确否过。
   空格子保持纯色、不加任何阴影，不抢视线。 */
.du-activityCell[data-level="1"],.du-activityCell[data-level="2"],.du-activityCell[data-level="3"],.du-activityCell[data-level="4"]{box-shadow:0 1px 2px rgba(0,0,0,.18),0 0 4px rgba(34,197,94,.3)}
.du-activityCell[data-level="4"]{box-shadow:0 1px 2px rgba(0,0,0,.2),0 0 7px rgba(34,197,94,.55)}
body[data-ds-dark-theme] .du-activityCell[data-level="1"],body[data-ds-dark-theme] .du-activityCell[data-level="2"],body[data-ds-dark-theme] .du-activityCell[data-level="3"],body[data-ds-dark-theme] .du-activityCell[data-level="4"]{box-shadow:0 1px 3px rgba(0,0,0,.55),0 0 5px rgba(34,197,94,.32)}
body[data-ds-dark-theme] .du-activityCell[data-level="4"]{box-shadow:0 1px 3px rgba(0,0,0,.55),0 0 8px rgba(34,197,94,.6)}
