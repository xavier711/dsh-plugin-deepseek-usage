 ...
 * separate handling — they are calendar weekends and stay off-peak.
 * @param cfg - plugin config (weekendOffPeakAt, holidayRanges, holidayOffPeakAt, timezoneOffsetMinutes).
 * @param time - epoch ms of the moment to classify.
 */
    ...
    ctx.webServer.register({
      ...
      handler: async (_req, res) => {
        try {
          ...
          // given day priced the way it did can see the reason.
          ...
          sendJson(res, 200, {
            ...
            weekendOffPeakAt: cfg.weekendOffPeakAt,
            holidayOffPeakAt: cfg.holidayOffPeakAt,
            offPeakDay: holidayToday !== null || weekendToday,
            offPeakReason: holidayToday !== null ? "holiday" : weekendToday ? "weekend" : null,
